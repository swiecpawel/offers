...
import {fetchAllOffers, fetchOffersByTech} from "../../slices/offer/offerSlice";
        ...
        return (
          ...
          >
            <FilterItem language={`${icon.lang}`}>
              <div className={style.insideIcon} onClick={() => dispatch(fetchOffersByTech(`${icon.lang}`))}>
                {icon.icon}
              </div>
            </FilterItem>
          </NavLink>
