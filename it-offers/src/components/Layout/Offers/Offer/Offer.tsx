...
const offer = ({language, title, logo, city, compName,
                salaryFrom, salaryTo, currency, technologies, date} : PropsOffer) => {
    ...
    const createdDate = new Date(parseInt(year), parseInt(month) - 1, parseInt(day));
    const timeBetween = (nowDate.getTime() - createdDate.getTime()) / (1000 * 3600 * 24);
                ...
                <div className={style.SubLeft}>
                    ...
                    <div className={style.column80}>
                        ...
                        <div className={style.row}>
                            <div className={style.smallIcon}><MdDomain size={14}/></div>
                            <div className={style.textItem}> {compName}</div>
                            <div className={style.smallIcon}><FaMapMarkerAlt size={14}/></div>
                    ...
                    <div className={style.column80}>
                        <div className={style.rowRight}>
                            <div className={style.salary}>
                                {separateThousands(salaryFrom)} - {separateThousands(salaryTo)} {currency}
                            </div>
                            {pastDays()}
                        </div>
